...
import  type Postagem from "../../../models/Postagem" // Importa o tipo Postagem para tipagem
...
function DeletarPostagem() {
    ...
    const [postagem, setPostagem] = useState<Postagem>({} as Postagem) // Estado para armazenar a postagem a ser deletada
    ...
    // useEffect para buscar a postagem quando o id mudar
    useEffect(() => {
        if (id !== undefined) {
            buscarPorId(id)
        }
    ...
    // Função para deletar a postagem
    async function deletarPostagem() {
        ...
        retornar() // Volta para a lista de postagens
    }
    ...
    return (
        <div className='container w-1/3 mx-auto'>
            ...
            <div className='border flex flex-col rounded-2xl overflow-hidden justify-between'>
                ...
                <div className="p-4">
                    {/* Exibe o título e texto da postagem */}
